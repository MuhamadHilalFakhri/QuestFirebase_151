...
class InsertViewModel(
    ...
    fun validateFields(): Boolean{
        ...
        val errorState = FormErrorState(
            ...
            dosen1 = if (event.dosen1.isNotEmpty()) null else "Dosen tidak boleh kosong",
            dosen2 = if (event.dosen2.isNotEmpty()) null else "Dosen tidak boleh kosong",
...
data class FormErrorState(
    ...
    fun isValid(): Boolean{
        return nim == null && nama == null && jenis_kelamin == null &&
                alamat == null && kelas == null && angkatan == null && judul_skripsi ==
                null && dosen1 == null  && dosen2 == null
    }
}
